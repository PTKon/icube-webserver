 ...
 */
public enum BaseDataEsClient implements InitEs<RestHighLevelClient, RequestOptions> {
    client;
    ...
    BaseDataEsClient() {
        ...
        restHighLevelClient = new RestHighLevelClient(
                RestClient.builder(Arrays.stream(BaseDataEsInitBean.getHosts().split(","))
                        .map(host -> new HttpHost(host, BaseDataEsInitBean.getPort(), "http"))
        ...
        HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory factory =
                new HttpAsyncResponseConsumerFactory.HeapBufferedResponseConsumerFactory(
                        BaseDataEsInitBean.getBufferLimitBytes());
        //获得builder
